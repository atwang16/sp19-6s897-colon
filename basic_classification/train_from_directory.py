...
def train_model_from_dir(
    ...
    train_generator = train_datagen.flow_from_directory(train_path, target_size=target_size, batch_size=batch_size, class_mode='binary', shuffle=True, shear_range=0.2, horizontal_flip=True, vertical_flip=True, rotation_range=360)         
    valid_datagen = ImageDataGenerator(preprocessing_function=preprocessing_function)
    validation_generator = train_datagen.flow_from_directory(valid_path, target_size=target_size, batch_size=batch_size, class_mode='binary', shuffle=True, shear_range=0.2, horizontal_flip=True, vertical_flip=True, rotation_range=360)
